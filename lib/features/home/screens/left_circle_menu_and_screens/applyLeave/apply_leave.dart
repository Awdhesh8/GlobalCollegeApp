      ...
      child: Column(
        children: [
          ...
          Obx(() => TextFormField(
                ...
                decoration: InputDecoration(
                  isDense: true,
                  suffixIcon: Icon(Iconsax.document_text),
                  labelText: 'Application',
                  errorText: controller.reasonError.value
                      ? 'Please enter a reason'
                      : null,
              ...
              return Dismissible(
                ...
                child: Container(
                  ...
                  child: ListTile(
                    ...
                    trailing: Icon(Icons.drag_handle), // Add icon for drag handle
                  ),
                ),
              );
            },
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          for (var leaveData in leaveHistoryList) {
            ...
            String formattedLeave =
                '${leaveData['stud_name']}, Leave Dates: ${leaveData['leave_date']}, Status: ${leaveData['leav_status']}, Reason: ${leaveData['leav_purpose']}, ';
